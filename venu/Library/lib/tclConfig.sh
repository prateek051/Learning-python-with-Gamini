...
# installed.
TCL_PREFIX='B:/Learning-python-with-Gamini/venu\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='B:/Learning-python-with-Gamini/venu\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='B:/Learning-python-with-Gamini/venu\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IB:/Learning-python-with-Gamini/venu\Library\include'
...
TCL_PACKAGE_PATH='B:/Learning-python-with-Gamini/venu\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LB:/Learning-python-with-Gamini/venu\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='B:/Learning-python-with-Gamini/venu\Library\lib\tclstub86.lib'
